...
HD_PWD='/home/wmpmiles/courses/comp4601/valjean-nnet/bnn_rtl/bnn_rtl.runs/system_bnn_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bnn_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bnn_0_0.tcl
