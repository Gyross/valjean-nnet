...
HD_PWD='C:/Users/X4/Documents/GitHub/valjean-nnet/custom_ip/New folder/custom_ip_lab/custom_ip_lab.runs/system_customip_lab_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_customip_lab_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_customip_lab_0_0.tcl
