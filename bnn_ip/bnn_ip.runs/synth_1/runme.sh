...
HD_PWD='/home/wmpmiles/courses/comp4601/valjean-nnet/bnn_ip/bnn_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bnn_v1_0.tcl
